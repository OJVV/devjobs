<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            <h3 class="font-extrabold text-4xl text-gray-600 mb-12"> Our available job openings.</h3>
                ...
                @forelse ($vacantes as $vacante )
                    <div class="md:flex md:justify-between md:items-center py-5">
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{route('vacantes.show', $vacante->id)}}" class="bg-indigo-500 p-3 text-sm uppercase font-bold text-white rounded-lg block text-center ">See Vacancy</a>
                        </div>
                    </div>
                @empty
                    <p class="p-3 text-center text-sm text-gray-600">No Vacancies</p>
                @endforelse
            </div>
        </div>
    </div>
